...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Register(
        RegisterPassengerRequest request, CancellationToken cancellationToken)
    {
        ...
        CancellationToken cancellationToken)
    {
        ...
        switch (result.Status)
        {
            ...
            case EmailOtpVerificationStatus
        ...
        // Use the actual method name from your TokenService.
        var tokenResult =
            _tokenService.CreateToken(passenger);
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (latestVerification is not null)
        {
            var nextAllowedAtUtc =
                latestVerification.CreatedAtUtc
                    .AddSeconds(60);
